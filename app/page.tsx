  ...
  return (
    ...
    >
      ...
      <div className="text-gray-400 w-full md:w-1/3  space-y-8">
        <p
          className={`ease-in-out duration-1000 transition-opacity transform
            ${
              mounted
                ? "text-3xl text-gray-200 delay-100  font-semibold"
                : "opacity-0"
            }`}
        >
          Zuunbileg.B
        ...
        <p
          className={`ease-in-out duration-1000 transition-all transform ${
            mounted
        ...
        >
          Creating imaginative concepts and turning them into reality is where
          my enthusiasm thrives. You can discover my extensive project portfolio
          <Link href="/projects" className="text-white font-semibold underline">
            {` here `}
          </Link>
          . Besides my projects, I also delve into graphic design, photography,
          and experimentation with interactivity.
        </p>
        <p
          className={
            mounted
        ...
        >
          Apart from my programming interests, I also have a passion for
          mountain biking, volleyball, photography, and cooking. You can check
          ...
          profile. If you happen to be in the same city as me ( currently in
          Ulaanbaatar ), perhaps we could meet up to enjoy some photography or
          coding together.
        </p>
        <div className="flex justify-center">
          <div className="h-px w-20 bg-white bg-opacity-30 rounded-full"></div>
        </div>
        <div
          className={`space-y-2
            ${
        ...
        >
          ...
          {dayjs(new Date()).format("YYYY")} © Zuunbileg
        </div>
      </div>
    </div>
  );
