...
const Navbar = () => {
  ...
  const handleMenu = () => {
    if (menu == true) {
      return (
        <div
          className={`fixed top-0 left-0 transition-all transform duration-300 bg-gradient-to-tr from-black to-stone-950  h-screen p-6 w-full ${
            menu ? "z-10 opacity-100" : "opacity-0 -z-10"
          }`}
        >
